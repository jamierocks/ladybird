...
public:
    ...
    void add_resource_timing_entry(JS::NonnullGCPtr<ResourceTiming::PerformanceResourceTiming> entry);
...
private:
    ...
    bool m_resource_timing_buffer_full_event_pending_flag { false };
    ...
    WebIDL::UnsignedLong m_resource_timing_secondary_buffer_current_size { 0 };

    // https://w3c.github.io/resource-timing/#dfn-resource-timing-secondary-buffer
    // FIXME: A resource timing secondary buffer to store PerformanceResourceTiming objects that is initially empty.
